        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border p-4">
            <h3 className="font-medium flex items-center gap-2 mb-3">
              ...
              Logging into CONNECT-21
            </h3>
            <ol className="list-decimal ml-5 space-y-2">
              <li>Ensure RMDE-01 is powered on</li>
              <li>Press and hold CONNECT-21 SD/RJ45 button for 5 seconds</li>
              <li>Connect Ethernet cable between CONNECT-21 ETH1 port and PC</li>
          ...
          <div className="rounded-lg border p-4">
            ...
            <ol className="list-decimal ml-5 space-y-2">
              <li>Check connectivity status on CONNECT-21 portal front page</li>
          ...
          <div className="rounded-lg border p-4">
            <h3 className="font-medium flex items-center gap-2 mb-3">
              ...
              DriveLink Cloud Services
            </h3>
            <ul className="list-disc ml-5 space-y-2">
              <li>Contact support for service agreement or trial version</li>
              <li>For portal access and support:
                <div className="ml-6 mt-1">
                  <span className="font-mono text-sm">support@drivelink.com</span>
                </div>
              </li>
              <li>Required information:
                <ul className="list-disc ml-6 mt-1">
                  <li>Customer and site details</li>
                  <li>CONNECT-21 and RMDE-01 serial numbers</li>
          ...
          <Alert>
            <AlertDescription>
              <strong>Important:</strong> To use DriveLink Services, you need a registered account. 
              Connected drives must be registered in the system database.
            </AlertDescription>
          </Alert>
        </div>
      </CardContent>
